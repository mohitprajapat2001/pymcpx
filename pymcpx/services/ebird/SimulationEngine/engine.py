"""
EbirdSimulationEngine — offline execution and simulation layer for the ebird service.
"""
...
class EbirdSimulationEngine:
    """Offline simulation engine for the ebird service."""
    ...
    def run(self, tool_name: str, inputs: dict[str, Any] | None = None) -> str:
        """Run an ebird tool by name, checking fixtures first."""
        inputs = inputs or {}

"""
ConverterSimulationEngine — offline execution and simulation layer for the converter service.
"""
...
from pymcpx.services.converter.SimulationEngine.utils import inputs_match
...
class ConverterSimulationEngine:
    """Offline simulation engine for the converter service."""
    ...
    def run(self, tool_name: str, inputs: dict[str, Any] | None = None) -> str:
        """Run a converter tool by name, checking fixtures first."""
        inputs = inputs or {}

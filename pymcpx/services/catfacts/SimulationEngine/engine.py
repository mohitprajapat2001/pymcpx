"""
CatfactsSimulationEngine — offline execution and simulation layer for the catfacts service.
"""
...
class CatfactsSimulationEngine:
    """Offline simulation engine for the catfacts service."""
    ...
    def run(self, tool_name: str, inputs: dict[str, Any] | None = None) -> str:
        """Run a catfacts tool by name, checking fixtures first."""
        inputs = inputs or {}

...
from pymcpx.services.screenshotlayer.tools import ScreenshotlayerCaptureTool
...
class ScreenshotlayerSimulationEngine:
    """Offline simulation engine for the Screenshotlayer service."""

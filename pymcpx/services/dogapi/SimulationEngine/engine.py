"""
DogapiSimulationEngine — offline execution and simulation layer for the dogapi service.
"""
...
class DogapiSimulationEngine:
    """Offline simulation engine for the dogapi service."""
    ...
    def run(self, tool_name: str, inputs: dict[str, Any] | None = None) -> str:
        """Run a dogapi tool by name, checking fixtures first."""
        inputs = inputs or {}

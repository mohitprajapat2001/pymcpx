"""
CataasSimulationEngine — offline execution and simulation layer for the cataas service.
"""
...
class CataasSimulationEngine:
    """Offline simulation engine for the cataas service."""
    ...
    def run(self, tool_name: str, inputs: dict[str, Any] | None = None) -> str:
        """Run a cataas tool by name, checking fixtures first."""
        inputs = inputs or {}

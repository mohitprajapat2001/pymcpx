"""
IpstackSimulationEngine — offline execution and simulation layer for the IPstack service.
"""
...
class IpstackSimulationEngine:
    """Offline simulation engine for the IPstack service."""
    ...
    def run(self, tool_name: str, inputs: dict[str, Any] | None = None) -> str:
        """Run an IPstack tool by name, checking fixtures first."""
        inputs = inputs or {}

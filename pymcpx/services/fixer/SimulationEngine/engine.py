"""
FixerSimulationEngine — offline execution and simulation layer for the Fixer service.
"""
...
class FixerSimulationEngine:
    """Offline simulation engine for the Fixer service."""
    ...
    def run(self, tool_name: str, inputs: dict[str, Any] | None = None) -> str:
        """Run a Fixer tool by name, checking fixtures first."""
        inputs = inputs or {}

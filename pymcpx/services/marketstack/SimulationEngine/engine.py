"""
MarketstackSimulationEngine — offline execution and simulation layer for the Marketstack service.
"""
...
class MarketstackSimulationEngine:
    """Offline simulation engine for the Marketstack service."""
    ...
    def run(self, tool_name: str, inputs: dict[str, Any] | None = None) -> str:
        """Run a Marketstack tool by name, checking fixtures first."""
        inputs = inputs or {}
